...
class Game(object):
	...
	def __init__(self, numCars):
		...
		self.walls = ((1250,269),(1090,270),(993,100),(200,100),(99,529),(1256,99),(1253,210),(210,210),(1250,269))
	...
	def initialize(self):
		...
		pygame.display.set_caption('Self driving car demo')
